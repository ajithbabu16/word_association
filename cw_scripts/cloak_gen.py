...
def extract_missing_letters(complete_phrase, puzzle, level_no=None):
    ...
    For every character in the puzzle that is a blank marker:
      ...
      -'$' indicateds a blank locked with cloak.
...
if __name__ == "__main__":
    csv_filename = sys.argv[1] if len(sys.argv) > 1 else "csv/claokv2_control.csv"
    json_filename = sys.argv[2] if len(sys.argv) > 2 else "generated/cloakv2_control.json"
